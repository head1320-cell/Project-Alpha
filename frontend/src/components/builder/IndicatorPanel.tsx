...
import { INDICATORS, CANDLESTICK_PATTERNS, CATEGORY_LABELS, CATEGORY_ORDER } from "@/lib/builder/constants";
import { useBuilderStore } from "@/lib/builder/store";
import type { BuilderIndicator, IndicatorCategory } from "@/types/builder";
