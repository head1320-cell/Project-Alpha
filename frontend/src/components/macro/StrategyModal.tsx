...
import type { StrategyDetail, StrategyAI, TacticalHolding } from "@/lib/screenerApi";
import type { Market } from "@/lib/macroData";
import { loadStrategyAI } from "@/lib/macroData";
