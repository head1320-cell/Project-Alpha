...
// ═══════════════════════════════════════════════════════════════════════════════
import { analysisApi, type MacroStrategies, type MacroRecommend, type MacroDashboard, type MacroValuation, type MacroCorrelations, type MacroTiming, type MacroTrajectory, type StrategyDetail, type StrategyAI, type StrategyBacktestConfig } from "@/shared/api/screenerApi";
